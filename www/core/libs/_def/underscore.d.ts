...
declare module UnderscoreBase {
	/**
	* underscore.js UnderscoreBase.throttle options.
	**/
...
interface UnderscoreStatic {
	...
	**/
	each<T>(
		list: UnderscoreBase.List<T>,
		iterator: UnderscoreBase.ListIterator<T, void>,
		context?: any): void;

	/**
	* @see UnderscoreBase.each
	* @param object Iterators over this object's properties.
	* @param iterator Iterator function for each property on `obj`.
	* @param context 'this' object in `iterator`, optional.
	**/
	each<T>(
		object: UnderscoreBase.Dictionary<T>,
		iterator: UnderscoreBase.ObjectIterator<T, void>,
		context?: any): void;
	...
	**/
	map<T, TResult>(
		list: UnderscoreBase.List<T>,
		iterator: UnderscoreBase.ListIterator<T, TResult>,
		context?: any): TResult[];

	/**
	* @see UnderscoreBase.map
	...
	**/
	map<T, TResult>(
		object: UnderscoreBase.Dictionary<T>,
		iterator: UnderscoreBase.ObjectIterator<T, TResult>,
		context?: any): TResult[];
	...
	**/
	collect<T, TResult>(
		list: UnderscoreBase.List<T>, iterator:
		UnderscoreBase.ListIterator<T, TResult>,
		context?: any): TResult[];
	...
	**/
	reduce<T, TResult>(
		list: UnderscoreBase.Collection<T>,
		iterator: UnderscoreBase.MemoIterator<T, TResult>,
		memo?: TResult,
		context?: any): TResult;

	/**
	* @see UnderscoreBase.reduce
	**/
	inject<T, TResult>(
		list: UnderscoreBase.Collection<T>,
		iterator: UnderscoreBase.MemoIterator<T, TResult>,
	...
	**/
	...
	/**
	* @see UnderscoreBase.reduceRight
	**/
	foldr<T, TResult>(
		list: UnderscoreBase.Collection<T>,
		iterator: UnderscoreBase.MemoIterator<T, TResult>,
	...
	**/
	find<T>(
		list: UnderscoreBase.List<T>,
		iterator: UnderscoreBase.ListIterator<T, boolean>,
		context?: any): T;

	/**
	* @see UnderscoreBase.find
	**/
	find<T>(
		list: UnderscoreBase.Dictionary<T>,
		iterator: UnderscoreBase.ListIterator<T, boolean>,
		context?: any): T;
	...
	**/
	max(list: UnderscoreBase.List<number>): number;
	...
	**/
	max<T>(
		list: UnderscoreBase.Collection<T>,
		iterator?: UnderscoreBase.ListIterator<T, any>,
		context?: any): T;
	...
	**/
	min(list: UnderscoreBase.List<number>): number;
	...
	**/
	sortBy<T, TSort>(
		list: UnderscoreBase.List<T>,
		iterator?: UnderscoreBase.ListIterator<T, TSort>,
		context?: any): T[];

	/**
	* @see UnderscoreBase.sortBy
	* @param iterator Sort iterator for each element within `list`.
	**/
	sortBy<T>(
		list: UnderscoreBase.List<T>,
	...
	**/
	groupBy<T>(
		list: UnderscoreBase.List<T>,
		iterator?: UnderscoreBase.ListIterator<T, any>,
		context?: any): UnderscoreBase.Dictionary<T[]>;

	/**
	* @see UnderscoreBase.groupBy
	...
	* returns an object with an index of each item.  Just like UnderscoreBase.groupBy, but for when you know your keys are unique.
	**/
	indexBy<T>(
		list: UnderscoreBase.List<T>,
		iterator: UnderscoreBase.ListIterator<T, any>,
	...
	**/
	countBy<T>(
		list: UnderscoreBase.List<T>,
		iterator?: UnderscoreBase.ListIterator<T, any>,
		context?: any): UnderscoreBase.Dictionary<number>;

	/**
	* @see UnderscoreBase.countBy
	...
	**/
	shuffle<T>(list: UnderscoreBase.Collection<T>): T[];
	...
	**/
	sample<T>(list: UnderscoreBase.Collection<T>, n: number): T[];

	/**
	* @see UnderscoreBase.sample
	**/
	sample<T>(list: UnderscoreBase.Collection<T>): T;
	...
	**/
	toArray<T>(list: UnderscoreBase.Collection<T>): T[];
	...
	**/
	size<T>(list: UnderscoreBase.Collection<T>): number;
	...
	**/
	first<T>(array: UnderscoreBase.List<T>): T;

	/**
	* @see UnderscoreBase.first
	* @param n Return more than one element from `array`.
	**/
	first<T>(
		array: UnderscoreBase.List<T>,
		n: number): T[];

	/**
	* @see UnderscoreBase.first
	**/
	head<T>(array: UnderscoreBase.List<T>): T;
	...
	* @see UnderscoreBase.first
	**/
	take<T>(array: UnderscoreBase.List<T>): T;
	...
	**/
	last<T>(array: UnderscoreBase.List<T>): T;

	/**
	* @see UnderscoreBase.last
	* @param n Return more than one element from `array`.
	**/
	last<T>(
		array: UnderscoreBase.List<T>,
	...
	**/
	compact<T>(array: UnderscoreBase.List<T>): T[];
	...
	**/
	union<T>(...arrays: UnderscoreBase.List<T>[]): T[];
	...
	**/
	intersection<T>(...arrays: UnderscoreBase.List<T>[]): T[];
	...
	**/
	difference<T>(
		array: UnderscoreBase.List<T>,
		...others: UnderscoreBase.List<T>[]): T[];
	...
	**/
	object<TResult extends {}>(
		keys: UnderscoreBase.List<string>,
		values: UnderscoreBase.List<any>): TResult;
	...
	**/
	...
	/**
	* @see UnderscoreBase.object
	**/
	object<TResult extends {}>(
		list: UnderscoreBase.List<any>,
		values?: any): TResult;
	...
	**/
	throttle(
		func: any,
		wait: number,
		options?: UnderscoreBase.ThrottleSettings): Function;
	...
	**/
	matches<T, TResult>(attrs: T): UnderscoreBase.ListIterator<T, TResult>;
	...
	**/
	...
	/**
	* Creates a function that returns the same value that is used as the argument of UnderscoreBase.constant
	* @param value Identity of this object.
	...
	* function. The settings argument should be a hash containing any UnderscoreBase.templateSettings that should
	* be overridden.
	...
	**/
	template(templateString: string, data?: any, settings?: UnderscoreBase.TemplateSettings): (...data: any[]) => string;

	/**
	* By default, Underscore uses ERB-style template delimiters, change the
	* following template settings to use alternative delimiters.
	**/
	templateSettings: UnderscoreBase.TemplateSettings;
...
interface Underscore<T> {
	...
	* @see UnderscoreBase.each
	**/
	each(iterator: UnderscoreBase.ListIterator<T, void>, context?: any): void;

	/**
	* @see UnderscoreBase.each
	**/
	each(iterator: UnderscoreBase.ObjectIterator<T, void>, context?: any): void;

	/**
	* @see UnderscoreBase.each
	**/
	forEach(iterator: UnderscoreBase.ListIterator<T, void>, context?: any): void;

	/**
	* @see UnderscoreBase.each
	**/
	forEach(iterator: UnderscoreBase.ObjectIterator<T, void>, context?: any): void;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.map
	**/
	map<TResult>(iterator: UnderscoreBase.ListIterator<T, TResult>, context?: any): TResult[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.map
	**/
	map<TResult>(iterator: UnderscoreBase.ObjectIterator<T, TResult>, context?: any): TResult[];

	/**
	* @see UnderscoreBase.map
	**/
	collect<TResult>(iterator: UnderscoreBase.ListIterator<T, TResult>, context?: any): TResult[];

	/**
	* @see UnderscoreBase.map
	**/
	collect<TResult>(iterator: UnderscoreBase.ObjectIterator<T, TResult>, context?: any): TResult[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.reduce
	**/
	reduce<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

	/**
	* @see UnderscoreBase.reduce
	**/
	inject<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

	/**
	* @see UnderscoreBase.reduce
	**/
	foldl<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.reduceRight
	**/
	reduceRight<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

	/**
	* @see UnderscoreBase.reduceRight
	**/
	foldr<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.find
	**/
	find(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): T;

	/**
	* @see UnderscoreBase.find
	**/
	detect(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): T;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.filter
	**/
	filter(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): T[];

	/**
	* @see UnderscoreBase.filter
	**/
	select(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): T[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.where
	**/
	where<U extends {}>(properties: U): T[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.findWhere
	**/
	...
	* @see UnderscoreBase.reject
	**/
	reject(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): T[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.all
	**/
	all(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): boolean;

	/**
	* @see UnderscoreBase.all
	**/
	every(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): boolean;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.any
	**/
	any(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): boolean;

	/**
	* @see UnderscoreBase.any
	**/
	some(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): boolean;
	...
	**/
	...
	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.invoke
	**/
	invoke(methodName: string, ...arguments: any[]): any;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.pluck
	**/
	pluck(propertyName: string): any[];

	/**
	* Wrapped type `number[]`.
	* @see UnderscoreBase.max
	**/
	max(): number;
	...
	* @see UnderscoreBase.max
	**/
	max(iterator: UnderscoreBase.ListIterator<T, number>, context?: any): T;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.max
	**/
	max(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): T;

	/**
	* Wrapped type `number[]`.
	* @see UnderscoreBase.min
	**/
	min(): number;
	...
	* @see UnderscoreBase.min
	**/
	min(iterator: UnderscoreBase.ListIterator<T, number>, context?: any): T;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.min
	**/
	min(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): T;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.sortBy
	**/
	sortBy(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): T[];
	...
	* @see UnderscoreBase.groupBy
	**/
	groupBy(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): UnderscoreBase.Dictionary<UnderscoreBase.List<T>>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.groupBy
	**/
	groupBy(iterator: string, context?: any): UnderscoreBase.Dictionary<T[]>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.indexBy
	**/
	indexBy(iterator: UnderscoreBase.ListIterator<T, any>, context?: any): UnderscoreBase.Dictionary<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.indexBy
	**/
	indexBy(iterator: string, context?: any): UnderscoreBase.Dictionary<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.countBy
	**/
	countBy(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): UnderscoreBase.Dictionary<number>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.countBy
	**/
	countBy(iterator: string, context?: any): UnderscoreBase.Dictionary<number>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.shuffle
	**/
	shuffle(): T[];
	...
	**/
	...
	/**
	* Wrapped type `any`.
	* @see UnderscoreBase.toArray
	**/
	toArray(): T[];

	/**
	* Wrapped type `any`.
	* @see UnderscoreBase.size
	**/
	size(): number;
	...
	**/
	...
	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.compact
	**/
	compact(): T[];

	/**
	* Wrapped type `any`.
	* @see UnderscoreBase.flatten
	**/
	flatten(shallow?: boolean): any[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.without
	**/
	without(...values: T[]): T[];

	/**
	* Wrapped type `any[][]`.
	* @see UnderscoreBase.union
	**/
	union(...arrays: UnderscoreBase.List<T>[]): T[];

	/**
	* Wrapped type `any[][]`.
	* @see UnderscoreBase.intersection
	**/
	intersection(...arrays: UnderscoreBase.List<T>[]): T[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.difference
	**/
	difference(...others: UnderscoreBase.List<T>[]): T[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.uniq
	**/
	uniq(isSorted?: boolean, iterator?: UnderscoreBase.ListIterator<T, any>): T[];

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.uniq
	**/
	uniq<TSort>(iterator?: UnderscoreBase.ListIterator<T, TSort>, context?: any): T[];

	/**
	* @see UnderscoreBase.uniq
	**/
	unique<TSort>(isSorted?: boolean, iterator?: UnderscoreBase.ListIterator<T, TSort>): T[];

	/**
	* @see UnderscoreBase.uniq
	**/
	unique<TSort>(iterator?: UnderscoreBase.ListIterator<T, TSort>, context?: any): T[];
	...
	**/
	...
	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.lastIndexOf
	**/
	lastIndexOf(value: T, from?: number): number;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.sortedIndex
	**/
	...
	**/
	...
	/**
	* Wrapped type `Function`.
	* @see UnderscoreBase.throttle
	**/
	throttle(wait: number, options?: UnderscoreBase.ThrottleSettings): Function;

	/**
	* Wrapped type `Function`.
	* @see UnderscoreBase.debounce
	**/
	debounce(wait: number, immediate?: boolean): Function;

	/**
	* Wrapped type `Function`.
	* @see UnderscoreBase.once
	**/
	once(): Function;

	/**
	* Wrapped type `number`.
	* @see UnderscoreBase.after
	**/
	after(func: Function): Function;

	/**
	* Wrapped type `Function`.
	* @see UnderscoreBase.wrap
	**/
	wrap(wrapper: Function): () => Function;

	/**
	* Wrapped type `Function[]`.
	* @see UnderscoreBase.compose
	**/
	compose(...functions: Function[]): Function;
	...
	********** */
	...
	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.keys
	**/
	keys(): string[];

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.values
	**/
	values(): T[];

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.pairs
	**/
	pairs(): any[][];

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.invert
	**/
	invert(): any;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.functions
	**/
	functions(): string[];
	...
	**/
	...
	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.extend
	**/
	extend(...sources: any[]): any;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.pick
	**/
	...
	**/
	...
	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.defaults
	**/
	defaults(...defaults: any[]): any;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.clone
	**/
	clone(): T;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.tap
	**/
	tap(interceptor: (...as: any[]) => any): any;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.has
	**/
	has(key: string): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isEqual
	**/
	isEqual(other: any): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isEmpty
	**/
	isEmpty(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isElement
	**/
	isElement(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isArray
	**/
	isArray(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isObject
	**/
	isObject(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isArguments
	**/
	isArguments(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isFunction
	**/
	isFunction(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isString
	**/
	isString(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isNumber
	**/
	isNumber(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isFinite
	**/
	isFinite(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isBoolean
	**/
	isBoolean(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isDate
	**/
	isDate(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isRegExp
	**/
	isRegExp(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isNaN
	**/
	isNaN(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isNull
	**/
	isNull(): boolean;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.isUndefined
	**/
	isUndefined(): boolean;
	...
	********** */
	...
	/**
	* Wrapped type `any`.
	* @see UnderscoreBase.identity
	**/
	identity(): any;

	/**
	* Wrapped type `number`.
	* @see UnderscoreBase.times
	**/
	...
	**/
	...
	/**
	* Wrapped type `string`.
	* @see UnderscoreBase.escape
	**/
	escape(): string;

	/**
	* Wrapped type `object`.
	* @see UnderscoreBase.result
	**/
	result(property: string): any;

	/**
	* Wrapped type `string`.
	* @see UnderscoreBase.template
	**/
	template(data?: any, settings?: UnderscoreBase.TemplateSettings): (...data: any[]) => string;
	...
	*********** */
	...
	/**
	* Wrapped type `any`.
	* @see UnderscoreBase.chain
	**/
	chain(): _Chain<T>;

	/**
	* Wrapped type `any`.
	* @see UnderscoreBase.value
	**/
...
interface _Chain<T> {
	...
	* @see UnderscoreBase.each
	**/
	each(iterator: UnderscoreBase.ListIterator<T, void >, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.each
	**/
	each(iterator: UnderscoreBase.ObjectIterator<T, void >, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.each
	**/
	forEach(iterator: UnderscoreBase.ListIterator<T, void >, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.each
	**/
	forEach(iterator: UnderscoreBase.ObjectIterator<T, void >, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.map
	**/
	map<TArray>(iterator: UnderscoreBase.ListIterator<T, TArray[]>, context?: any): _ChainOfArrays<TArray>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.map
	**/
	map<TResult>(iterator: UnderscoreBase.ListIterator<T, TResult>, context?: any): _Chain<TResult>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.map
	**/
	map<TArray>(iterator: UnderscoreBase.ObjectIterator<T, TArray[]>, context?: any): _ChainOfArrays<TArray>;
	
	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.map
	**/
	map<TResult>(iterator: UnderscoreBase.ObjectIterator<T, TResult>, context?: any): _Chain<TResult>;

	/**
	* @see UnderscoreBase.map
	**/
	collect<TResult>(iterator: UnderscoreBase.ListIterator<T, TResult>, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.map
	**/
	collect<TResult>(iterator: UnderscoreBase.ObjectIterator<T, TResult>, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.reduce
	**/
	reduce<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.reduce
	**/
	inject<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.reduce
	**/
	foldl<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.reduceRight
	**/
	reduceRight<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.reduceRight
	**/
	foldr<TResult>(iterator: UnderscoreBase.MemoIterator<T, TResult>, memo?: TResult, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.find
	**/
	find(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): _ChainSingle<T>;

	/**
	* @see UnderscoreBase.find
	**/
	detect(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.filter
	**/
	filter(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.filter
	**/
	select(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.reject
	**/
	reject(iterator: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.all
	**/
	all(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.all
	**/
	every(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.any
	**/
	any(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.any
	**/
	some(iterator?: UnderscoreBase.ListIterator<T, boolean>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.max
	**/
	max(iterator: UnderscoreBase.ListIterator<T, number>, context?: any): _ChainSingle<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.max
	**/
	max(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): _ChainSingle<T>;
	...
	* @see UnderscoreBase.min
	**/
	min(iterator: UnderscoreBase.ListIterator<T, number>, context?: any): _ChainSingle<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.min
	**/
	min(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): _ChainSingle<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.sortBy
	**/
	sortBy(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.groupBy
	**/
	groupBy(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.indexBy
	**/
	indexBy(iterator: UnderscoreBase.ListIterator<T, any>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.countBy
	**/
	countBy(iterator?: UnderscoreBase.ListIterator<T, any>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.union
	**/
	union(...arrays: UnderscoreBase.List<T>[]): _Chain<T>;

	/**
	* Wrapped type `any[][]`.
	* @see UnderscoreBase.intersection
	**/
	intersection(...arrays: UnderscoreBase.List<T>[]): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.difference
	**/
	difference(...others: UnderscoreBase.List<T>[]): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.uniq
	**/
	uniq(isSorted?: boolean, iterator?: UnderscoreBase.ListIterator<T, any>): _Chain<T>;

	/**
	* Wrapped type `any[]`.
	* @see UnderscoreBase.uniq
	**/
	uniq<TSort>(iterator?: UnderscoreBase.ListIterator<T, TSort>, context?: any): _Chain<T>;

	/**
	* @see UnderscoreBase.uniq
	**/
	unique<TSort>(isSorted?: boolean, iterator?: UnderscoreBase.ListIterator<T, TSort>): _Chain<T>;

	/**
	* @see UnderscoreBase.uniq
	**/
	unique<TSort>(iterator?: UnderscoreBase.ListIterator<T, TSort>, context?: any): _Chain<T>;
	...
	* @see UnderscoreBase.throttle
	**/
	throttle(wait: number, options?: UnderscoreBase.ThrottleSettings): _Chain<T>;
	...
	* @see UnderscoreBase.template
	**/
	template(data?: any, settings?: UnderscoreBase.TemplateSettings): (...data: any[]) => _Chain<T>;
