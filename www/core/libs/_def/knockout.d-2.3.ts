...
interface KnockoutBindingHandlers {
    ...
    jqNumber: KnockoutBindingHandler;
    jqPhone: KnockoutBindingHandler;
    jqEmail: KnockoutBindingHandler;
    tabShown: KnockoutBindingHandler;
    gaqPush: KnockoutBindingHandler;
    afterForeach: KnockoutBindingHandler;

    sliderPriceApartment: KnockoutBindingHandler;
    sliderAreaApartment: KnockoutBindingHandler; // TODO: не используется!
}
...
interface KnockoutExtenders {
    ...
    // extensions
    numeric: (target: any, precision: number) => any;
    thousands: (target: any, delimiter: string) => any;
}
